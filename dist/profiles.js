 ...
 */
export function resolveLevel(filePath, frontmatter, config) {
 ...
 */
function matchDirectoryLevel(filePath, config) {
 ...
 */
function readFileAtRef(baseRef, relativePath, gitRoot) {
    try {
 ...
 */
function rawQualityLevel(frontmatter) {
